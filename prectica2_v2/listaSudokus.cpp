...
// booleano que indica si se pudo registrar un nuevo sudoku, para lo cual también
// hay que tener en cuenta si la lista está o no llena.
...
int buscarPos(const tListaSudokus &lista, const tSudoku &sudoku) {
  ...
  // por nivel
  int pos;
  string name = sudoku.fichero int ini = 0, fin = lista.cont - 1, mitad;
  bool encontrado = false;
